...
return [
    ...
    'App' => [
        ...
        'fullBaseUrl' => 'https://e-pv.mcaz.co.zw',
        'imageBaseUrl' => 'img/',
        'cssBaseUrl' => 'css/',
        'jsBaseUrl' => 'js/',
        'paths' => [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'djkhaledmcazpvdev'),
    ],
    ...
    //         'className' => 'Smtp',
    //         // The following keys are used in SMTP transports
    //         //'host' => '192.168.1.64',///196.27.112.206
    //         'host' => 'smtp.office365.com',
	//     'port' => 587,
    //         'timeout' => 30,
    //         'username' => 'noreply@mcaz.co.zw',
    //         'password' => 'pgndxzwkqjtqtmnd',
    //         'client' => null,
    //         'tls' => true,
    //         'url' => env('EMAIL_TRANSPORT_DEFAULT_URL', null),
    //     ],
    ...
    'EmailTransport' => [
        'default' => [
            'className' => 'Smtp',
            // The following keys are used in SMTP transports
            'host' => 'ssl://smtp.gmail.com',//196.27.112.206
            'port' => 465,
            'timeout' => 30,
