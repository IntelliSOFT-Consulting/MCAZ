...
class UsersController extends AppController
{
    ...
    public function index()
    {
        ...
        if ($this->request->params['_ext'] === 'csv') {
            $_serialize = 'query';
            $_header = [
                'id', 'name', 'username', 'email', 'Group', 'Phone Number', 'name_of_institution',
                'institution_address', 'institution_code', 'Designation'
            ];
            $_extract = [
                'id', 'name', 'username', 'email',
                function ($row) use ($_groups) {
                    return $_groups[$row['group_id']] ?? '';
                }, //'Group', 
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $user->last_password = date('Y-m-d H:i:s');
    ...
    {
        $fieldList = [
            'Users.id', 'Users.name', 'Users.email', 'Users.username', 'Users.group_id', 'Users.phone_no', 'Users.last_password',
