...
class UsersBaseController extends AppController
{
    ...
    public function dashboard() {
        ...
        $ce2bs = $this->paginate($this->Ce2bs->find('all')->where(['submitted' => 2, 'status NOT IN' => ['UnSubmitted'], 'IFNULL(copied, "N") !=' => 'old copy']), ['scope' => 'ce2b', 'order' => ['Ce2bs.status' => 'asc', 'Ce2bs.id' => 'desc'],
