...
class VigibaseApiComponent extends Component
{
    public function sadr_e2b($sadr)
    {
        ...
        foreach ($sadr['sadr_list_of_drugs'] as $sadrListOfDrug) {
            $listofdrugs .= '<drug>
                <drugcharacterization>'.($sadrListOfDrug['suspected_drug'] == 1) ? 1 : 2 .'</drugcharacterization>
                ...
                <drugstructuredosageunit>'.(!empty($sadrListOfDrug['dose_id'])) ? $dose[$sadrListOfDrug['dose_id']] : ''.'</drugstructuredosageunit>
                ...
                <drugdosagetext/>
                <drugdosageform/>
                <drugadministrationroute>'.(!empty($sadrListOfDrug['route_id'])) ? $route[$sadrListOfDrug['route_id']] : ''.'</drugadministrationroute>
                ...
                <drugstartdateformat>'.(!empty($sadrListOfDrug['start_date'])) ? 102 : ''.'</drugstartdateformat>
                <drugstartdate>'.(!empty($sadrListOfDrug['start_date'])) ? date('Ymd', strtotime($sadrListOfDrug['start_date'])) : ''.'</drugstartdate>
                <drugstartperiod/>
                <drugstartperiodunit/>
                <druglastperiod/>
                <druglastperiodunit/>
                <drugenddateformat>102</drugenddateformat>
                <drugenddate>'.(!empty($sadrListOfDrug['stop_date'])) ? date('Ymd', strtotime($sadrListOfDrug['stop_date'])) : ''.'</drugenddate>
    ...
    <ichicsrmessageheader>
     ...
     <safetyreport>
        ...
        <patient>
            ...
            <patientsex>'.($sadr['gender'] == 'Male') ? 1 : 2 .'</patientsex>
