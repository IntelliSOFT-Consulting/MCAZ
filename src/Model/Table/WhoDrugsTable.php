 ...
 * WhoDrugs Model
 *
 * @method \App\Model\Entity\WhoDrug get($primaryKey, $options = [])
 * @method \App\Model\Entity\WhoDrug newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\WhoDrug[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\WhoDrug|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\WhoDrug patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\WhoDrug[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\WhoDrug findOrCreate($search, callable $callback = null, $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class WhoDrugsTable extends Table
{
