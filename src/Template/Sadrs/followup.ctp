<?php $this->start('actions'); ?>
    <?php echo $this->Html->link('<button class="btn btn-primary"> <i class="fa fa-backward" aria-hidden="true"></i> Back to Initial Report </button>', ['controller' => 'Sadrs', 'action' => 'view', $sadr->id], ['escape' => false]); ?>
<?php $this->end(); ?>
...
function getFollowUpChoice(sel){
   ...
   <?= $this->Form->create($followup, ['type' => 'file', 'url' => ['action' => 'followup', $sadr->id, $followup->id]]) ?>
    ...
    <div class="row">
            <h5 class="text-center"><span class="label label-default"><em>NEW FOLLOWUP!!</em></span></h5>
        <div class="col-xs-6">
          <?php 
              ...
              echo $this->Form->control('date_of_onset_of_reaction', array(
                ...
                'templates' => ['dateWidget' => '<div class="col-xs-6">{{day}}-{{month}}-{{year}}</div>',
    ...
    <div class="row">
        <div class="col-xs-8"><?= $this->Form->control('description_of_reaction', ['label' => 'Description of ADR <span class="sterix fa fa-asterisk" aria-hidden="true"></span>', 'escape' => false, 'templates' => 'app_form']); ?></div>
    ...
    <div class="row">
        <div class="col-xs-12"><?= $this->element('multi/sadr_list_of_drugs', [
          'editable' => true,
           'followup_form' => true]);?></div>   
    </div>
    <div class="row">
        <div class="col-xs-12"><?= $this->element('multi/attachments', [
          'editable' => true, 
          'followup_form' => true]);?></div>   
    </div>
    <div class="well">
