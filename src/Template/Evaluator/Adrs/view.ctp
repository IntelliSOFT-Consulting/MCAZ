...
<?php $this->start('actions'); ?>
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#report" aria-controls="report" role="tab" data-toggle="tab"><?= $adr->reference_number ?></a></li>
  ...
  <div class="tab-content">
    ...
    <?php echo $this->Html->link('<button class="btn btn-primary"> <i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF </button>', ['controller' => 'Adrs', 'action' => 'view', '_ext' => 'pdf', 'prefix' => false, $adr->id], ['escape' => false]); ?>
