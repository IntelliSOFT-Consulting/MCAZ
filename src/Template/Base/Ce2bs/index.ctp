            ...
            <tr style="background-color:<?php echo $tr; ?>">
                ...
                <td>
                    <?php if (empty($ce2b->messageid)) {
                            ...
                            echo $ce2b->messageid;
                            echo  $this->Html->link('&nbsp;<span class="label label-warning"> Resend</span>', ['action' => 'vigibase', $ce2b->id, '_ext' => 'json', 'prefix' => false], ['escape' => false, 'style' => 'color: whitesmoke;', 'class' => 'vigibase']);
                        }
                        ?>
                </td>
