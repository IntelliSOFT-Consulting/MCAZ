...
<div class="row">
    <div class="col-xs-12">
        ...
        <h4 class="text-center">Assigned to: <span
                <?php if(!in_array("Evaluated", Hash::extract($ce2b->report_stages, '{n}.stage'))) { ?> id="assigned-to"
                class="editable" data-type="select" data-pk="<?= $ce2b->id ?>"
                ...
                <?= $evaluators->toArray()[$ce2b->assigned_to] ?></span> on <?= $ce2b->assigned_date ?></h4>
        <?php
        	}
     	?>
    </div>
    ...
    <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-12">
                <h5 class="text-center">Send request to evaluator <?= $evaluators->toArray()[$ce2b->assigned_to]?> for
                    more information</h5>
            </div>
            <div class="col-xs-12">
                <?php
