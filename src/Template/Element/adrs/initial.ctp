    ...
    <div class="row">
        <div class="col-xs-12">
            <h3 class="text-center">
                <span class="text-center"><?= $this->Html->image("mcaz_3.png", ['fullBase' => true, 'style' => 'width: 70%;']); ?></span> <br>SERIOUS ADVERSE EVENT REPORTING FORM
            </h3>
            <div class="row">
                <div class="col-xs-12">
                    <h5 class="text-center">ZIMBABWE REPORTING FORM FOR SERIOUS ADVERSE EVENT(SAE) </h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <?php
                    echo $this->Form->control('name_of_institution', ['label' => 'Institution','value'=>'Hello']);
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <?php
                    echo $this->Form->control('date_of_adverse_event', ['label' => 'Date of Adverse Event', 'escape' => false,'value'=>'Tupo Site', 'type' => 'text']);
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h4 class="text-center">Section B</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-6">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    echo $this->Form->control('location_event_specify', [
                        'label' => 'If Other, specify', 'escape' => false,
                        'templates' => ($editable) ? [
            ...
            <div class="row">
                <div class="col-xs-12"><b class="text-center">
                        <p>Section C</p>
            ...
            <div class="row">
                <div class="col-xs-12"><?php
                                        echo $this->Form->control('medical_history', [
                                            'label' => 'Summary of relevant past medical history of participant', 'escape' => false,
                                            'templates' => ($editable) ? [
                                                'label' => '<div class="col-sm-offset-1 col-sm-11"><label {{attrs}}>{{text}}</label></div>',
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    echo $this->Form->control('investigations', [
                        'label' => '(d) Investigations-Laboratory and any other significant investigations conducted', 'escape' => false,
                        'templates' => ($editable) ? [
                            'label' => '<div class="col-sm-offset-1 col-sm-11"><label {{attrs}}>{{text}}</label></div>',
                            'textarea' => '<div class="col-sm-offset-1 col-sm-11"><textarea class="form-control" rows="2" name="{{name}}"{{attrs}}>{{value}}</textarea></div>',
                        ] : 'view_form_text'
            ...
            <div class="row">
                <div class="col-xs-12"><?php
                                        ...
                                        echo $this->Form->control('management', [
                                            'label' => '(f) Management (Include management of study treatment, continued, temporarily held, reduced dose, permanent discontinuation, off Product)', 'escape' => false,
                                            'templates' => ($editable) ? [
                                                'label' => '<div class="col-sm-offset-1 col-sm-11"><label {{attrs}}>{{text}}</label></div>',
                                                'textarea' => '<div class="col-sm-offset-1 col-sm-11"><textarea class="form-control" rows="2" name="{{name}}"{{attrs}}>{{value}}</textarea></div>',
                                            ] : 'view_form_text'
