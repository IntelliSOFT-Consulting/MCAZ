    ...
    <div class="col-xs-12">
        ...
        ?>
            ...
            <h4 class="text-center">Assigned to: <span
                    ...
                    id="assigned-to" class="editable" data-type="select" data-pk="<?= $adr->id ?>"
                    ...
                    <?= $this->cell('Signature::index', [$adr->assigned_to]) ?></span> on <?= $adr->assigned_date ?>
            </h4>
            <?php
        	}
     	?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h5 class="text-center">Send request to evaluator
                        <?= $this->cell('Signature::index', [$adr->assigned_to]) ?> for more information</h5>
                </div>
                <div class="col-xs-12">
                    <?php
                    echo $this->Form->control('adr_pr_id', ['type' => 'hidden', 'value' => $adr->id, 'escape' => false, 'templates' => 'table_form']);
