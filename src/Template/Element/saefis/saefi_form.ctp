    ...
    <div class="row">
        <div class="col-xs-12">
          ...
          ?>
            ...
            <div>
                <button name="submitted" value="1" id="saefiSaveChanges0" class="btn btn-primary btn-sm" type="submit"
          ...
          ?>
            ...
            <div>
                <button name="submitted" value="1" id="saefiSaveChanges3" class="btn btn-primary btn-sm" type="submit"
                    formnovalidate="formnovalidate">
                    <span class="fa fa-edit" aria-hidden="true"></span> Save changes
                </button>
            </div>
          ...
          ?>
            ...
            <div>
                <button name="submitted" value="1" id="saefiSaveChanges5" class="btn btn-primary btn-sm" type="submit"
                    formnovalidate="formnovalidate">
                    <span class="fa fa-edit" aria-hidden="true"></span> Save changes
                </button>
            </div>
