  ...
  <div class="row">
    <div class="col-xs-12">
          ...
          <div class="row">
            <div class="col-xs-4">
              <table class="table table-condensed vertical-table">
                <tr><th><label>Provinces </label></th>
            ...
            <div class="col-xs-4">
              <table class="table table-condensed vertical-table">
                <tr><th><label>AEFI Report ID </label></th>
          ...
          <div class="row">              
            ...
            <div class="col-xs-6">
              <table class="table table-condensed vertical-table">
                <tr><th><label>Telephone # Landline (with code) </label></th>
                    <td><?= $saefi->telephone ?></td>
                </tr>
                <tr><th><label>Mobile </label></th>
                    <td><?= $saefi->mobile ?></td>
                </tr>
          ...
          <div class="row">
            <div class="col-xs-8">
              <table class="table table-condensed vertical-table">
                <tr><th><label><b>Place of vaccination</b> </label></th>
                    <td><?= $saefi->place_vaccination ?></td>
                </tr>
                <tr><th><label>Other, (specify) </label></th>
                    <td><?= $saefi->place_vaccination_other ?></td>
                </tr>
                <tr><th><label><b>Type of site</b></label></th>
                    <td><?= $saefi->site_type ?></td>
                </tr>
                <tr><th><label>Other, (specify) </label></th>
                    <td><?= $saefi->site_type_other ?></td>
                </tr>
                <tr><th><label>Vaccination in </label></th>
            ...
            <div class="col-xs-3">
              <table class="table table-condensed vertical-table">
                <tr><th><label>Date AEFI reported </label></th>
                    <td><?= $saefi->report_date ?></td>
                </tr>
                <tr><th><label>Date investigation started </label></th>
                    <td><?= $saefi->start_date ?></td>
                </tr>
                <tr><th><label>Date investigation completed </label></th>
          ...
          <div class="row">
            <div class="col-xs-10 col-xs-offset-1">
              <table class="table table-condensed vertical-table">
                <tr><th><label>Patient’s physical address <small class="muted">(Street name, house number, ward/village, phone number etc.)</small>: </label></th>
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <table class="table table-condensed vertical-table">
                <tr><th><label><b>OR</b> Age group </label></th>
              ...
              <table class="table table-bordered table-condensed">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= ($saefi->aefi_list_of_vaccines[$i]['suspected_drug']) ? $checked : $nChecked; ?>  </td>
                  </tr>
          ...
          <div class="row">
            <div class="col-xs-7">
              <table class="table table-condensed vertical-table">
                <tr><th><label>Date and time of first/key symptom </label></th>
                    <td><?= $saefi->symptom_date ?></td>
                </tr>
                <tr><th><label>Date of hospitalization </label></th>
                    <td><?= $saefi->hospitalization_date ?></td>
                </tr>
                <tr><th><label><b>Status on the date of investigation</b> </label></th>
                    <td><?= $saefi->status_on_date ?></td>
                </tr>
                <tr><th><label>If died, date and time of death </label></th>
            ...
            <div class="col-xs-4">                
              <table class="table table-condensed vertical-table">
                <tr><th><label><b>Autopsy done?</b> </label></th>
                    <td><?= $saefi->autopsy_done ?></td>
                </tr>
                <tr><th><label>If yes, date: </label></th>
                    <td><?= $saefi->autopsy_done_date ?></td>
                </tr>
                <tr><th><label><b>Autopsy Planned?</b> </label></th>
...
*specify</label></td>
            ...
            <div class="col-xs-8">
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <div class="col-xs-5">
                      <table class="table table-condensed vertical-table">
                        <tr><th><label>Currently pregnant?</label></th>
                  ...
                  <div class="col-xs-5">
                      <table class="table table-condensed vertical-table">
                        <tr><th><label>Currently breastfeeding?</label></th>
          ...
          <div class="row">
            <div class="col-xs-8">
                ...
                <div class="row">
                  <div class="col-xs-8">
                      <table class="table table-condensed vertical-table">
                        <tr><th><label>The birth was:</label></th>
                            <td><?= $saefi->infant ?></td>
                        </tr>
                      </table> 
                  </div>
                  <div class="col-xs-4">
                      <table class="table table-condensed vertical-table">
                        <tr><th><label>Birth Weight</label></th>
          ...
          <div class="row">
            <div class="col-xs-8">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Delivery procedure was:</label></th>
            ...
            <div class="col-xs-4">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>If complication, specify</label></th>
          ...
          <div class="row">
            <div class="col-xs-6">
              <table class="table table-condensed vertical-table">                  
                <tr><th></th> <td><?= ($saefi->source_verbal) ? $checked : $nChecked; ?><label> Verbal autopsy</label></td></tr>
                <tr><th>If verbal autopsy, please mention the source</th> 
            ...
            <div class="col-xs-6">
              <table class="table table-condensed vertical-table">                  
                <tr><th></th> <td><?= ($saefi->source_documents) ? $checked : $nChecked; ?><label> Documents</label></td></tr>
                <tr><th></th> <td><?= ($saefi->source_other) ? $checked : $nChecked; ?><label> Other</label></td></tr>
                <tr><th>If other, specify</th> 
          ...
          <div class="row">
            <div class="col-xs-12">
              <table class="table table-condensed vertical-table">
                  <tr><th><label>Name of the person who first examined/treated the patient:</label></th>
          ...
          <div class="row">
              <div class="col-xs-3 col-xs-offset-1">
                <table class="table table-condensed vertical-table">
                    <tr><th><label>Name and contact information of person completing these clinical details:</label></th>
              ...
              <div class="col-xs-4">
                <table class="table table-condensed vertical-table">
                    <tr><th><label>Date/time</label></th>
          ...
          <div class="row">
            <div class="col-xs-12">                
              <table class="table table-condensed vertical-table">
                  <tr><th>Provisional / Final diagnosis: </th>
        ...
        <div class="col-xs-12">
          <div class="row">
            <div class="col-xs-12">
              <h4 class="text-center">Number vaccinated for each antigen at session site. Attach record if available. </h4>
            </div>
          </div>
          <div class="row">
              <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-6">
              <table class="table table-condensed vertical-table">
                <tr><th><label>Are AD syringes used for immunization?</label></th>
            ...
            <div class="col-xs-6">
              <table class="table table-condensed vertical-table">
                <tr><th><label>If no, specify the type of syringes used:</label></th>
          ...
          <div class="row">
            <div class="col-xs-12">  
              <table class="table table-condensed vertical-table">
                <tr><th><label>Specific key findings/additional observations and comments:</label></th>
          ...
          <div class="row">
            <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Same reconstitution syringe used for multiple vials of same vaccine?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Same reconstitution syringe used for reconstituting different vaccines?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Separate reconstitution syringe for each vaccine vial?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Separate reconstitution syringe for each vaccination?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Are the vaccines and diluents used the same as those recommended by the manufacturer?</label></th>
        ...
        <div class="row">
            <div class="col-xs-12">
              <table class="table table-condensed vertical-table">
                <tr><th><label>Is the temperature of the vaccine storage refrigerator monitored?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>If “yes”, was there any deviation outside of 2-8° C after the vaccine was placed inside?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>If “yes”, provide details of monitoring separately.</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Was the correct procedure for storing vaccines, diluents and syringes followed?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Was any other item (other than EPI vaccines and diluents) in the refrigerator or freezer?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Were any partially used reconstituted vaccines in the refrigerator?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Were any unusable vaccines (expired, no label, VVM at stages 3 or 4, frozen) in the refrigerator?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Were any unusable diluents (expired, manufacturer not matched, cracked, dirty ampoule) in the store?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Was cold chain properly maintained during transportation?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Was the vaccine carrier sent to the site on the same day as vaccination?</label></th>
              ...
              <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Were conditioned coolant-packs used?</label></th>
        ...
        <div class="row">
            <div class="col-xs-12">
                <table class="table table-condensed vertical-table">
                  <tr><th><label>Were any similar events reported within a time period similar to when the adverse event occurred and in the same locality?</label></th>
                      <td><?= $saefi->similar_events ?></td>
                  </tr>
                  <tr><th><label>If yes, describe:</label></th>
                      <td><?= $saefi->similar_events_describe ?></td>
                  </tr>
                  <tr><th><label>If yes, how many events/episodes?</label></th>
                      <td><?= $saefi->similar_events_episodes ?> <p>Of those affected, how many are:</p></td>
                  </tr>
                  <tr><th><label>Vaccinated:</label></th>
                      <td><?= $saefi->affected_vaccinated ?></td>
                  </tr>
                  <tr><th><label>Not Vaccinated:</label></th>
                      <td><?= $saefi->affected_not_vaccinated ?></td>
                  </tr>
                  <tr><th><label>Unknown</label></th>
                      <td><?= $saefi->affected_unknown ?></td>
                  </tr>
                  <tr><th><label>Other comments:</label></th>
