 ...
 <?php foreach ($saefi->committees as $committee_review) {  ?>
            ...
            <div class="amend-form">
              ...
              <div class="row">
                ...
                <div class="col-xs-4 lefty">
                  ...
                  <?php echo $this->element('comments/list', ['comments' => $committee_review->saefi_comments]) ?> 
                  <?php if(!in_array("FinalStage", Hash::extract($saefi->report_stages, '{n}.stage'))) { ?>
                  <?php  
                        echo $this->element('comments/add', [
                          'model' => ['model_id' => $saefi->id, 'foreign_key' => $committee_review->id, 
                                      'model' => 'Saefis', 'category' => 'committee', 'url' => 'add-from-committee/saefis']]) 
                  ?>
                  <?php } ?>
                </div>
            </div>  
  ...
  <div class="row">
    <div class="col-xs-12">
      <hr>
          <?php  
          if(in_array("1", Hash::extract($saefi->aefi_causalities, '{n}.chosen'))) {
