...
?>
 ...
 <div class="row">
    <div class="col-xs-12">
        ...
        <?php
            if($this->request->params['_ext'] != 'pdf') echo $this->Html->link('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download PDF ', ['action' => 'download', '_ext' => 'pdf', $aefi_causality->saefi_id, 'causality'], ['escape' => false, 'class' => 'btn btn-xs btn-success active topright']);
