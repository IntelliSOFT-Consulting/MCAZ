        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-6">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Patient first name </label></th>
                            <td><?= $aefi->patient_name ?></td>
                        </tr>
                        <tr>
                            <th><label>Patient Surname </label></th>
                            <td><?= $aefi->patient_surname ?></td>
                        </tr>
                        <tr>
                            <th><label>Patient next of Kin</label></th>
                            <td><?= $aefi->patient_next_of_kin ?></td>
                        </tr>
                        <tr>
                            <th><label>Patient's physical address </label></th>
                            <td><?= $aefi->patient_address ?></td>
                        </tr>
                        <tr>
                            <th><label>Patient's phone number</label></th>
                ...
                <div class="col-xs-6">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Reporter's name </label></th>
                            <td><?= $aefi->reporter_name ?></td>
                        </tr>
                        <tr>
                            <th><label>Designation <span class="sterix fa fa-asterisk" aria-hidden="true"></span></label></th>
                            <td><?= ($aefi->designation_id) ? $designations->toArray()[$aefi->designation_id] : '' ?>
                            </td>
                        </tr>
                        <tr>
                            <th><label>Reporter Institution</label></th>
                        ...
                        <tr>
                            <th><label>Reporter phone</label></th>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Name of vaccination center </label></th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><?= ($aefi->aefi_list_of_vaccines[$i]['suspected_drug']) ? $checked : $nChecked; ?>
                                        </td>
                                    </tr>
            ...
            <div class="row">
                <div class="col-xs-2">
                    ...
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th></th>
                            <td><?= ($aefi->ae_afebrile) ? $checked : $nChecked; ?><label> afebrile</label></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td><?= ($aefi->ae_febrile) ? $checked : $nChecked; ?><label> febrile</label></td>
                        </tr>
                    </table>
                    ...
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th></th>
                            <td><?= ($aefi->ae_3days) ? $checked : $nChecked; ?><label> >3 days</label></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td><?= ($aefi->ae_beyond_joint) ? $checked : $nChecked; ?><label> beyond nearest
                                    joint</label></td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-3">
                    ...
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th></th>
                            <td><?= ($aefi->ae_encephalopathy) ? $checked : $nChecked; ?><label> Encephalopathy</label>
                            </td>
                        </tr>
                        <tr>
                            <th></th>
                            <td><?= ($aefi->ae_abscess) ? $checked : $nChecked; ?><label>Abscess</label></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td><?= ($aefi->ae_sepsis) ? $checked : $nChecked; ?><label>Sepsis</label></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td><?= ($aefi->ae_anaphylaxis) ? $checked : $nChecked; ?><label>Anaphylaxis </label></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td><?= ($aefi->ae_fever) ? $checked : $nChecked; ?><label>Fever≥38°C </label></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td><?= ($aefi->ae_toxic_shock) ? $checked : $nChecked; ?><label>Toxic shock syndrome
                                </label></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td><?= ($aefi->ae_thrombocytopenia) ? $checked : $nChecked; ?><label>Thrombocytopenia
                                </label></td>
                        </tr>
                    </table>
                </div>
                <div class="col-xs-3">
                    ...
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th></th>
                            <td><?= ($aefi->ae_other) ? $checked : $nChecked; ?><label>Other (specify)</label></td>
                        </tr>
                        <tr>
                ...
                <div class="col-xs-3">
                    ...
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Date & Time AEFI started</label></th>
                            <td><?= $aefi->aefi_date ?></td>
                        </tr>
                        <tr>
                            <th><label>Was patient hospitalized?</label></th>
                            <td><?= $aefi->patient_hospitalization ?></td>
                        </tr>
                        <tr>
                            <th><label>Date patient notified event to health system</label></th>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Adverse Events:</label></th>
                        ...
                        <tr>
                            ...
                            <th><label>Describe AEFI (Signs and symptoms): </label></th>
                            <td><?= $aefi->user_description ?></td>
                        </tr>

                        <tr>
                            <th><label>Treatment provided?</label></th>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Serious?</span></label></th>
                            <td><?= $aefi->serious ?></td>
                        </tr>
                        <tr>
                            <th><label>If yes,</label></th>
                            <td><?= $aefi->serious_yes ?></td>
                        </tr>
                        <tr>
                            <th><label>Other medically important reason</label></th>
            ...
            <div class="row">
                <div class="col-xs-6">
                    <table class="table table-condensed vertical-table">
                        ...
                        <tr>
                            <th><label>If died, date of death</label></th>
                            <td><?= $aefi->died_date ?></td>
                        </tr>
                        <tr>
                            <th><label>Autopsy done</label></th>
                            <td><?= $aefi->autopsy ?></td>
                        </tr>
                    </table>
                </div>
  ...
  (e.g. other cases)..</label></th>
            ...
            <div class="row">
                <div class="col-xs-6">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Date report received at district level</label></th>
                ...
                <div class="col-xs-6">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Investigation needed</label></th>
                            <td><?= $aefi->investigation_needed ?></td>
                        </tr>
                        <tr>
                            <th><label>If yes, date investigation planned</label></th>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Date report received at national level</label></th>
