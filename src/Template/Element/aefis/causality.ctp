...
<div class="row">
    <div class="col-xs-12">
        <h3 class="text-center text-success">Causality Assessment</h3>
        <hr>
        <?php
          ...
          ?>
                ...
                <div class="col-xs-4">
                    ...
                    <?= $this->Form->control('aefi_causalities.'.$ekey.'.diagnosis_meet', ['type' => 'radio', 
                     'label' => false, 'value' => $aefi['aefi_causalities'][$ekey]['diagnosis_meet'] ? $aefi['aefi_causalities'][$ekey]['diagnosis_meet']: 'Yes',
        ...
        ?>
            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                  ...
                  // echo $this->Form->control('causality_pr_id', ['type' => 'hidden', 'value' => (($aefi->evaluations[$ekey]['id']) ?? 100), 'escape' => false, 'templates' => 'table_form']); //original 
                  echo $this->Form->control('causality_pr_id', ['type' => 'hidden', 'value' =>  '', 'escape' => false, 'templates' => 'table_form']);
              ...
              ?>
                    ...
                    //  'label' => false, 'value' => $aefi['aefi_causalities'][$ekey]['prescribing_error'] ?? $aefi['prescribing_error'],  // @Japheth original
                    'label' => false, 'value' =>   $aefi['prescribing_error'],
                     'templates' => 'radio_form',
                     'options' => ['Yes' => 'Yes', 'No' => 'No', 'Unknown' => 'Unknown', 'Not applicable' => 'Not applicable']]); ?>
                                            </div>
                                        </td>
                                  ...
                                  'value' => $aefi['prescribing_error_specify'] ]); ?>
                                    ...
                                    'type' => 'radio',
                                    'label' => false,
                                    // 'value' => $aefi['aefi_causalities'][$ekey]['vaccine_unsterile'] ?? $aefi['vaccine_unsterile'], //@ Japheth
                                    'value'=>$aefi['vaccine_unsterile'],
                                    'templates' => 'radio_form',
                                    'options' => ['Yes' => 'Yes', 'No' => 'No', 'Unknown' => 'Unknown', 'Not applicable' => 'Not applicable']]); ?>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-xs-12 r23">
                                                ...
                                                'type' => 'radio', 
                                                'label' => false,
                                                // 'value' => $aefi['aefi_causalities'][$ekey]['vaccine_condition'] ?? $aefi['vaccine_condition'], //@ Japheth
                                                'value'=>$aefi['vaccine_condition'],
                                                'templates' => 'radio_form' ,
                                                'options' => ['Yes' => 'Yes', 'No' => 'No', 'Unknown' => 'Unknown', 'Not applicable' => 'Not applicable']]); ?>
                                            </div>
                                        </td>
                     ...
                     'label' => false, 
                    //  'value' => $aefi['aefi_causalities'][$ekey]['vaccine_reconstitution'] ?? $aefi['vaccine_reconstitution'], // @ Japheth
                    'value' =>$aefi['vaccine_reconstitution'],
                     'templates' => 'radio_form' ,
                     'options' => ['Yes' => 'Yes', 'No' => 'No', 'Unknown' => 'Unknown', 'Not applicable' => 'Not applicable']]); ?>
                                            </div>
                                        </td>
                     ...
                     'label' => false, 
                    //  'value' => $aefi['aefi_causalities'][$ekey]['vaccine_handling'] ?? $aefi['vaccine_handling'],  // @ Japheth
                    'value'=>$aefi['vaccine_handling'],
                     'templates' => 'radio_form' ,
                     'options' => ['Yes' => 'Yes', 'No' => 'No', 'Unknown' => 'Unknown', 'Not applicable' => 'Not applicable']]); ?>
                                            </div>
                                        </td>
                     ...
                     'label' => false,
                      // 'value' => $aefi['aefi_causalities'][$ekey]['acute_illness'] ?? $aefi['existing_illness'],  // @ Japheth
                      'value'=>$aefi['existing_illness'],
                     'templates' => 'radio_form',
                     'options' => ['Yes' => 'Yes', 'No' => 'No', 'Unknown' => 'Unknown', 'Not Applicable' => 'Not Applicable']]); ?>
                                            </div>
                                        </td>
