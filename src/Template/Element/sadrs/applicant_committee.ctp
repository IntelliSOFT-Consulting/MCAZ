...
<hr>
<br>
 <?php foreach ($sadr->committees as $committee_review) {  ?>
      <div class="row">
        <div class="col-xs-12">          
                ...
                <div class="col-xs-4 lefty">
                  ...
                  <?php  
                        echo $this->element('comments/add', [
                          'model' => ['model_id' => $sadr->id, 'foreign_key' => $committee_review->id, 
                                      'model' => 'Sadrs', 'category' => 'applicant', 'url' => 'add-from-applicant/sadrs']]) 
                  ?>
                  <?php } ?>
                </div>
            </div>  
