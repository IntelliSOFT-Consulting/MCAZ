    ...
    <div class="row">
        <div class="col-xs-12">
            <h5 class="text-center"> MCAZ Reference Number:
                <strong><?= ($sadr->submitted == 2) ? $sadr->reference_number : $sadr->created->i18nFormat('dd-MM-yyyy HH:mm:ss'); ?></strong>
            </h5>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
          ...
          ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h4 class="text-center">Adverse Reaction</h4>
                </div>
            </div>
          ...
          ?>
            ...
            <!-- <div class="row">
            <div class="col-xs-6"><?php //$this->Form->control('duration', ['type' => 'textarea', 'type' => 'textarea', 'label' => 'Duration:']); 
                                  ?></div>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <?= $this->Form->control('description_of_reaction', ['type' => 'textarea', 'type' => 'textarea', 'label' => 'Description of ADR <span class="sterix fa fa-asterisk" aria-hidden="true"></span>', 'escape' => false]); ?>
                </div>
                <div class="col-xs-4"></div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-5"><?= $this->Form->control('severity_reason', [
                                ...
                                'options' => [
                                  'Death' => 'Death', 'Life-threatening' => 'Life-threatening', 'Hospitalization/Prolonged' => 'Hospitalization/Prolonged', 'Disabling' => 'Disabling',
            ...
            <div class="row">
                <div class="col-xs-6">
                    <?= $this->Form->control('medical_history', ['type' => 'textarea', 'type' => 'textarea', 'label' => 'Relevant Medical History']); ?>
                </div>
                <div class="col-xs-6">
                    <?= $this->Form->control('past_drug_therapy', ['type' => 'textarea', 'type' => 'textarea', 'label' => 'Relevant Past Drug Therapy']); ?>
                </div>
            </div>

            <div class="row">
                <div class="col-xs-8">
                    <?= $this->Form->control('lab_test_results', ['type' => 'textarea', 'type' => 'textarea', 'label' => 'Laboratory test Results']); ?>
                </div>
                <div class="col-xs-4"></div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h4 class="text-center">Current Medication</h4>
                </div>
            </div>
      ...
      ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table id="listofdrugsform" class="table table-bordered table-condensed">
                        <thead>
                            <tr>
                                <th colspan="2"> Generic Name <span class="sterix fa fa-asterisk"
                                        aria-hidden="true"></span></th>
                                <th> Brand Name </th>
                                <th> Batch Number</th>
                                <th colspan="2"> Dose <span class="sterix fa fa-asterisk" aria-hidden="true"></span>
                                </th>
                                <th colspan="2"> Route and Frequency <span class="sterix fa fa-asterisk"
                                        aria-hidden="true"></span></th>
                                <th> Indication </th>
                                <th> Date Started <span class="sterix fa fa-asterisk" aria-hidden="true"></span></th>
                                <th> Date Stopped </th>
                                <th colspan="2"> Tick Suspected Drug(s) <span class="sterix fa fa-asterisk"
                                        aria-hidden="true"></span></th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    echo $this->Form->control('sadr_list_of_drugs.0.drug_name', [
                  ...
                  ?>
                                ...
                                <td><?php echo $this->Form->control('sadr_list_of_drugs.0.dose', [
                      'type' => 'textarea', 'label' => false,
                    ]); ?></td>
                                <td>
                                    <?php
                  ...
                  ?>
                    ...
                    ?>
                                ...
                                <td><?= $this->Form->control('sadr_list_of_drugs.0.indication', ['type' => 'textarea', 'label' => false,]); ?>
                                </td>
                                <td>
                                    <?php
                  ...
                  ?>
                                ...
                                <td>
                                    <?php
                  echo $this->Form->control('sadr_list_of_drugs.0.stop_date', [
                    'type' => 'textarea', 'label' => false,
                  ]);
                  ?>
                                </td>
              ...
              ?>
                        ...
                        echo $this->Form->control('sadr_list_of_drugs.' . $i . '.drug_name', [
                          'type' => 'textarea', 'label' => false,
                        ]);
                        ?>
                                </td>
                      ...
                      ?>
                                ...
                                <td><?php echo $this->Form->control('sadr_list_of_drugs.' . $i . '.dose', [
                          'type' => 'textarea', 'label' => false,
                        ]); ?></td>
                                <td>
                                    <?php
                      ...
                      ?>
                        ...
                        ?>
                                ...
                                <td><?= $this->Form->control('sadr_list_of_drugs.' . $i . '.indication', ['type' => 'textarea', 'label' => false,]); ?>
                                </td>
                                <td>
                                    <?php
                      ...
                      ?>
                                ...
                                <td>
                                    <?php
                      echo $this->Form->control('sadr_list_of_drugs.' . $i . '.stop_date', [
                        'type' => 'textarea', 'label' => false,
                        'templates' => 'dates_form'
                      ]);
                      ?>
                      ...
                      ?>
                                ...
                                <td>
                                    <button type="button" class="btn btn-default btn-sm remove-row" value="<?php if (isset($sadr['sadr_list_of_drugs'][$i]['id'])) {
                                                                                                echo $sadr['sadr_list_of_drugs'][$i]['id'];
                                                                                              } ?>">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h4 class="text-center">Concomitant (Other) drugs taken, including herbal medicines & Dates/period
                        taken:
            ...
            <div class="row">
              ...
              ?>
                        ...
                        echo $this->Form->control('sadr_other_drugs.' . $i . '.drug_name', [
                          'type' => 'textarea', 'label' => false,
                        ]);
                        ?>
                                </td>
                                <td>
                                    <?php
                      echo $this->Form->control('sadr_other_drugs.' . $i . '.start_date', [
                        'type' => 'textarea', 'label' => false,
                        'templates' => 'dates_form'
                      ]);
                      ?>
                                ...
                                <td>
                                    <?php
                      echo $this->Form->control('sadr_other_drugs.' . $i . '.stop_date', [
                        'type' => 'textarea', 'label' => false,
                        'templates' => 'dates_form'
                      ]);
                      ?>
                      ...
                      ?>
                                ...
                                <td><button type="button" class="btn btn-default remove-cd-row" value="<?php if (isset($sadr['sadr_other_drugs'][$i]['id'])) {
                                                                                              echo $sadr['sadr_other_drugs'][$i]['id'];
                                                                                            } ?>">
                                        <i class="fa fa-minus"></i>
                                    </button>
                                </td>
