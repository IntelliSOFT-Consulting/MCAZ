...
<div class="sadr_form">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-8">
                    <?= $this->Form->control('description_of_reaction', ['label' => 'Description of ADR <span class="sterix fa fa-asterisk" aria-hidden="true"></span>', 'escape' => false]); ?>
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
              ...
              ?>
                ...
                <div class="col-md-5" id="choice-severity">
                    <?= $this->Form->control('severity_reason', ['type' => 'select', 
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <?= $this->Form->control('past_drug_therapy', ['label' => 'Relevant Past Drug Therapy']); ?></div>
            </div>

            <div class="row">
                <div class="col-md-8">
                    <?= $this->Form->control('lab_test_results', ['label' => 'Laboratory test Results']); ?></div>
                <div class="col-md-4"></div>
            </div>
