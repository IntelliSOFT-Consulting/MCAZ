    ...
    <div class="row">
        <div class="col-xs-12">
          ...
          echo $this->Form->control('date_of_birth', array(
            ...
            'label' => 'Date of Birth',
            'templates' => ($editable) ? [
              'dateWidget' => '<div class="col-xs-6">{{day}}-{{month}}-{{year}}</div>',
          ...
          ?>
            ...
            <!-- <div class="row">
            <div class="col-xs-6"><?php //$this->Form->control('duration', ['label' => 'Duration:']); 
                                  ?></div>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <?= $this->Form->control('description_of_reaction', ['label' => 'Description of ADR', 'type' => 'text', 'escape' => false]); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <?= $this->Form->control('user_description', ['label' => 'More Description']); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-4">
            ...
            ?>
                ...
                <div class="col-xs-5" id="choice-severity"><?= $this->Form->control('severity_reason', [
                                                      'type' => 'select',
            ...
            <div class="row">
                <div class="col-xs-12">
                    <?= $this->Form->control('medical_history', ['label' => 'Relevant Medical History, including Allergies']); ?>

                </div>
                <div class="col-xs-12">
                    <?= $this->Form->control('past_drug_therapy', ['label' => 'Relevant Past Drug Therapy']); ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <?= $this->Form->control('lab_test_results', ['label' => 'Laboratory test Results']); ?>
                </div>
            </div>

            <div class="row">
                <div class="col-xs-12">
                    <?= $this->Form->control('any_other_information', ['label' => 'Any other information']); ?>
                </div>
            </div>
