                    ...
                    <td>
                        <?php
                            echo $this->Form->control('severity', 
                                ['type' => 'radio', 'label' => 'Serious?', 'templates' => 'radio_form', 'placeholder' => '*Patient Initials*',
                    ...
                    <td>
                        <?php
                            echo $this->Form->control('province_id', 
                                ['label' => false, 'templates' => 'clear_form', 'options' => $provinces, 'placeholder' => '*Province*',
                                 'empty' => true]);
                        ?>                        
    ...
    <div class="col-md-2">
        ...
        <div class="dropdown"  style="margin-top: 14px;">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
            <li><a href="#">Reference number</a></li>
