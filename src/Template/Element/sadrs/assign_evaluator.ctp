            ...
            if ($prefix == 'manager') { ?>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        ...
                        // echo $this->Form->control('user_id', ['type' => 'hidden', 'value' => $user_id, 'escape' => false, 'templates' => 'table_form']);
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                                <button type="submit" class="btn btn-success active" id="registerUser"><i class="fa fa-user" aria-hidden="true"></i>
                                    Assign Self</button>
                            </div>
