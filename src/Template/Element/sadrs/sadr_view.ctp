    ...
    <div class="row">
        <div class="col-xs-12">
            <h5 class="text-center"> MCAZ Reference Number:
                <strong><?= ($sadr->reference_number) ? $sadr->reference_number : $sadr->created->i18nFormat('dd-MM-yyyy HH:mm:ss'); ?></strong>
            </h5>
        </div>
    </div>
        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-6">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Clinic/Hospital Name </label></th>
                            <td><?= $sadr->name_of_institution ?></td>
                        </tr>
                        <tr>
                            <th><label>Patient Initials</label></th>
                ...
                <div class="col-xs-6">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Clinic/Hospital Number </label></th>
                            <td><?= $sadr->institution_code ?></td>
                        </tr>
                        <tr>
                            <th><label>VCT/OI/TB Number</label></th>
                            <td><?= $sadr->ip_no ?></td>
                        </tr>
                        <tr>
            ...
            <div class="row">
                <div class="col-xs-6">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Date of onset of Reaction </label></th>
                            <td><?= $sadr->date_of_onset_of_reaction ?></td>
                        </tr>
                        <tr>
                            <th><label>Did reaction occur in utero?</label></th>
                ...
                <div class="col-xs-6">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Date of end of Reaction </br> <i>(if it ended)</i></label></th>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Adverse Reactions </label></th>
                        ...
                        ?>
                        <tr>
                            <th><label>Description of ADR </label></th>
                            <td><?= $sadr->user_description ?></td>
                        </tr>
                    </table>
            ...
            <div class="row">
                ...
                <div class="col-xs-5" id="choice-severity">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Reason for Seriousness</label></th>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Relevant Medical History, including Allergies</label></th>
                ...
                <div class="col-xs-12">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Relevant Past Drug Therapy</label></th>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Laboratory test Results</label></th>
                    ...
                    <table class="table table-bordered table-condensed">
                        <thead>
                            <tr>
                                ...
                                <th> Date Stopped </th>
                                <th> Tick Suspected Drug(s) <span class="sterix fa fa-asterisk"
                                        aria-hidden="true"></span> </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= ($sadr->sadr_list_of_drugs[$i]['frequency_id']) ? $frequencies->toArray()[$sadr->sadr_list_of_drugs[$i]['frequency_id']] : '' ?>
                                </td>
                                ...
                                <td><?= ($sadr->sadr_list_of_drugs[$i]['suspected_drug']) ? $checked : $nChecked; ?>
                                </td>
                            </tr>
                            <?php }
                            }; ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Relatedness of suspected medicine(s) to ADR:</label></th>
            ...
            <div class="row">
                <div class="col-xs-6">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Reporter name </label></th>
                        ...
                        <tr>
                            <th><label>Institution Name </label></th>
                ...
                <div class="col-xs-6">
                    <table class="table table-condensed vertical-table">
                        <tr>
                            <th><label>Designations </label></th>
                            <td><?= ($sadr->designation_id) ? $designations->toArray()[$sadr->designation_id] : '' ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th><label>Institution Address </label></th>
