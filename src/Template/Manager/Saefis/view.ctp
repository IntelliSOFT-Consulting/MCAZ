...
<?php $this->start('actions'); ?>
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#report" aria-controls="report" role="tab" data-toggle="tab"><?= $saefi->reference_number ?></a></li>
    ...
    <li role="presentation"><a href="#assign" aria-controls="assign" role="tab" data-toggle="tab">
        <?php 
            if(empty($saefi->assigned_to)) {
                ...
                echo "Assigned to:".$evaluators->toArray()[$saefi->assigned_to];
            }
         ?>
    </a></li>
  ...
  <div class="tab-content">
    ...
    <?php echo $this->Html->link('<button class="btn btn-primary"> <i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF </button>', ['controller' => 'Saefis', 'action' => 'view', '_ext' => 'pdf', 'prefix' => false, $saefi->id], ['escape' => false]); ?>
    ...
    <?php } else { ?>
        <small><?= '<b>Assigned To</b>:'.$evaluators->toArray()[$saefi->assigned_to]?></small>
    <?php }  ?>
<?php $this->end(); ?>
...
<!-- </div> -->
    ...
    <div role="tabpanel" class="tab-pane" id="request_reporter">
        <?php  echo $this->element('saefis/request_reporter') ?>
    </div>
