    ...
    <li class="<?=  ($this->request->params['controller'] == 'Aefis') ? 'active' : ''; ?>">
      ...
      <?php if (($prefix == 'manager' || $prefix == 'evaluator') && $this->request->params['controller'] == 'Aefis' ) { ?>
          <ul class="nav van-<?= $prefix ?>">
            ...
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Committee') ? 'active' : ''; ?>"><?= $this->Html->link('<b>4.</b> Committee '. $aCommittee , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Committee'], array('escape' => false)); ?> </li>   
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Correspondence') ? 'active' : ''; ?>"><?= $this->Html->link('<b>5.</b> Correspondence '. $aCorrespondence , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Correspondence'], array('escape' => false)); ?> </li>  
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'ApplicantResponse') ? 'active' : ''; ?>"><?= $this->Html->link('<b>6.</b> Response '. $aApplicantResponse , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'ApplicantResponse'], array('escape' => false)); ?> </li>   
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Presented') ? 'active' : ''; ?>"><?= $this->Html->link('<b>7.</b> PVCT 2 '. $aPresented , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Presented'], array('escape' => false)); ?> </li>   
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'FinalFeedback') ? 'active' : ''; ?>"><?= $this->Html->link('<b>8.</b> Feedback '. $aFinalFeedback , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'FinalFeedback'], array('escape' => false)); ?> </li>  
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'VigiBase') ? 'active' : ''; ?>"><?= $this->Html->link('<b>9.</b> VigiBase '. $aVigiBase , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'VigiBase'], array('escape' => false)); ?> </li>   
          </ul>
        <?php } ?>
    </li>
    <li class="<?=  ($this->request->params['controller'] == 'Saefis') ? 'active' : ''; ?>">
      ...
      <?php if (($prefix == 'manager' || $prefix == 'evaluator') && $this->request->params['controller'] == 'Saefis' ) { ?>
          <ul class="nav van-<?= $prefix ?>">
            ...
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Committee') ? 'active' : ''; ?>"><?= $this->Html->link('<b>4.</b> Committee '. $saCommittee , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Committee'], array('escape' => false)); ?> </li> 
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Correspondence') ? 'active' : ''; ?>"><?= $this->Html->link('<b>5.</b> Correspondence '. $saCorrespondence , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Correspondence'], array('escape' => false)); ?> </li> 
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'ApplicantResponse') ? 'active' : ''; ?>"><?= $this->Html->link('<b>6.</b> Response '. $saApplicantResponse , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'ApplicantResponse'], array('escape' => false)); ?> </li>   
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Presented') ? 'active' : ''; ?>"><?= $this->Html->link('<b>7.</b> PVCT 2 '. $saPresented , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Presented'], array('escape' => false)); ?> </li>  
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'FinalFeedback') ? 'active' : ''; ?>"><?= $this->Html->link('<b>8.</b> Feedback '. $saFinalFeedback , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'FinalFeedback'], array('escape' => false)); ?> </li>  
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'VigiBase') ? 'active' : ''; ?>"><?= $this->Html->link('<b>9.</b> VigiBase '. $saVigiBase , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'VigiBase'], array('escape' => false)); ?> </li>    
          </ul>
        <?php } ?>
    </li>
    <li class="<?=  ($this->request->params['controller'] == 'Adrs') ? 'active' : ''; ?>">
      ...
      <?php if (($prefix == 'manager' || $prefix == 'evaluator') && $this->request->params['controller'] == 'Adrs' ) { ?>
          <ul class="nav van-<?= $prefix ?>">
            ...
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Committee') ? 'active' : ''; ?>"><?= $this->Html->link('<b>4.</b> Committee '. $rCommittee , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Committee'], array('escape' => false)); ?> </li>
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Correspondence') ? 'active' : ''; ?>"><?= $this->Html->link('<b>5.</b> Correspondence '. $rCorrespondence , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Correspondence'], array('escape' => false)); ?> </li>  
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'ApplicantResponse') ? 'active' : ''; ?>"><?= $this->Html->link('<b>6.</b> Response '. $rApplicantResponse , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'ApplicantResponse'], array('escape' => false)); ?> </li>  
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Presented') ? 'active' : ''; ?>"><?= $this->Html->link('<b>7.</b> PVCT 2 '. $rPresented , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Presented'], array('escape' => false)); ?> </li>  
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'FinalFeedback') ? 'active' : ''; ?>"><?= $this->Html->link('<b>8.</b> Feedback '. $rFinalFeedback , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'FinalFeedback'], array('escape' => false)); ?> </li> 
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'VigiBase') ? 'active' : ''; ?>"><?= $this->Html->link('<b>9.</b> VigiBase '. $rVigiBase , ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'VigiBase'], array('escape' => false)); ?> </li>   
          </ul>
        <?php } ?>
    </li>
    <?php } ?>
