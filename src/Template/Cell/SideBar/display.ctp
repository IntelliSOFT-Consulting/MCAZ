      ...
      <?= $this->Html->link('<i class="fa fa-file" aria-hidden="true"></i> &nbsp; ADRS', ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix], array('escape' => false)); ?>
        <?php if ($prefix == 'manager' && $this->request->params['controller'] == 'Sadrs' ) { ?>
          <ul class="nav van-<?= $prefix ?>">
            ...
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Unassigned') ? 'active' : ''; ?>"><?= $this->Html->link('&nbsp;&nbsp; &nbsp;  <i class="fa fa-minus" aria-hidden="true"></i> Unassigned', ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Unassigned'], array('escape' => false)); ?> </li>
            ...
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Reviewed') ? 'active' : ''; ?>"><?= $this->Html->link('&nbsp;&nbsp; &nbsp;  <i class="fa fa-minus" aria-hidden="true"></i> Committee Reviewed', ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Reviewed'], array('escape' => false)); ?> </li>
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Request1') ? 'active' : ''; ?>"><?= $this->Html->link('&nbsp;&nbsp; &nbsp; <i class="fa fa-minus" aria-hidden="true"></i> Request info <small>(Evaluator)</small>', ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Request1'], array('escape' => false)); ?> </li>
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Request2') ? 'active' : ''; ?>"><?= $this->Html->link('&nbsp;&nbsp; &nbsp; <i class="fa fa-minus" aria-hidden="true"></i> Request info <small>(Reporter)</small>', ['controller' => 'Sadrs', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Request2'], array('escape' => false)); ?> </li>
