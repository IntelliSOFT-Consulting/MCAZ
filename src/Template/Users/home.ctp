  ...
  <div class="col-md-4">
    <div style="min-height: 352px">
      ...
      <p>Adverse Event Following Immunization.
        <a class="btn btn-success tiptip" href="/aefis/add" data-original-title="Report AEFI" role="button"><i class="fa fa-plus" aria-hidden="true"></i></a>
      </p>
      <ul class="list-unstyled">
        <?php
        $i = 1;
    ...
    <p class="has-error">Serious Adverse Event Following Immunization.
      <a class="btn btn-warning active tiptip" data-original-title="Report SAEFI" href="/saefis/add" role="button"><i class="fa fa-plus" aria-hidden="true"></i></a>
    </p>
    <ul class="list-unstyled">
      <?php
      $i = 1;
