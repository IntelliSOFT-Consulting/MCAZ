        ...
        <tbody>
            ...
            <tr>
                ...
                <?php 
                        ...
                        echo $this->Form->postLink('<span class="label label-warning">Restore</span>', ['action' => 'delete', 1, $user->id, 'prefix' => $prefix], ['confirm' => __('Are you sure you want to restore {0}?', $user->name), 'escape' => false]);
                    } 
                ?>
                </td>
            </tr>
