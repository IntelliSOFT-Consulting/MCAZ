...
<?= $this->Html->link('<i class="fa fa-plus" aria-hidden="true"></i> MedDRA LLT', ['controller' => 'Meddras', 'action' => 'Add', 'prefix' => $prefix], array('escape' => false, 'class' => 'btn btn-primary')); ?> &nbsp;


<hr>
<h1 class="page-header">MedDRA LLTs</h1>
                    ...
                    <td>
                        <?php
                            ...
                            echo $this->Form->control('name', 
                                ['label' => false, 'templates' => 'clear_form', 'placeholder' => '*terminology*']);
                        ?>
                    </td>
                    <td>                        
                    ...
                    <td>                        
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            ...
                            <li><?= $this->Paginator->sort('terminology') ?></li>
                          </ul>
                        </div>
                    </td>
                </tr>
    ...
    <table class="table table-striped table-bordered">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('terminology') ?></th>
