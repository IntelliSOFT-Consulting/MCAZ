  ...
  function constructLOVTr(intId) {
    ...
    var trWrapper = '\
          <tr>\
            <td>{i2}</td>\
            <td>\
            <input class="form-control" name="aefi_list_of_vaccines[{i}][id]" id="aefi-list-of-vaccines-{i}-id" type="hidden"> \
            <input class="form-control" name="aefi_list_of_vaccines[{i}][vaccine_name]" id="aefi-list-of-vaccines-{i}-vaccine-name" type="text">\
            </td>\
            <td>\
            <input class="form-control" name="aefi_list_of_vaccines[{i}][manufacturer]" id="aefi-list-of-vaccines-{i}-manufacturer-name" type="text">\
            </td>\
            <td>\
            ...
            <td>\
                <button type="button" class="btn btn-danger btn-sm remove-vaccine"><i class="fa fa-minus"></i> </button>\
            </td>\
          </tr>\
        ';
