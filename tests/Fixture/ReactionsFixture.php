...
class ReactionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'reaction_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2018-07-21 11:34:47',
            'modified' => '2018-07-21 11:34:47'
        ],
    ];
}
