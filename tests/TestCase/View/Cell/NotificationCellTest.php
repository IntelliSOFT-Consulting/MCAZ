...
use App\View\Cell\NotificationCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\NotificationCell Test Case
 */
class NotificationCellTest extends TestCase
{
     ...
     * Test subject
     *
     * @var \App\View\Cell\NotificationCell
     */
    public $Notification;
    ...
    public function setUp()
    {
        ...
        $this->Notification = new NotificationCell($this->request, $this->response);
    }
